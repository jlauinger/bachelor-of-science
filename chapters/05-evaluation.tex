...
\begin{figure}[H]
	...
	\caption{Results: Varying Scrambler Initialization for 1000 experiments at MCS 0}
...
Similarly to the scrambler initialization, the MAC header field preceeding the sender MAC address could also influence detection quality. This is due to the convolutional encoder as described in section \ref{sec:mac-phy}.
