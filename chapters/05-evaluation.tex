...
\begin{figure}[p]
	\centering
	\begin{tabular}{cc}
		\subfloat[MCS 0]{\includegraphics[width=0.45\textwidth]{gfx/plots/awgn-mcs0}} &
		\subfloat[MCS 1]{\includegraphics[width=0.45\textwidth]{gfx/plots/awgn-mcs1}} \\
		\subfloat[MCS 2]{\includegraphics[width=0.45\textwidth]{gfx/plots/awgn-mcs2}} &
		\subfloat[MCS 3]{\includegraphics[width=0.45\textwidth]{gfx/plots/awgn-mcs3}} \\
		\subfloat[MCS 4]{\includegraphics[width=0.45\textwidth]{gfx/plots/awgn-mcs4}} &
		\subfloat[MCS 5]{\includegraphics[width=0.45\textwidth]{gfx/plots/awgn-mcs5}} \\
		\subfloat[MCS 6]{\includegraphics[width=0.45\textwidth]{gfx/plots/awgn-mcs6}} &
		\subfloat[MCS 7]{\includegraphics[width=0.45\textwidth]{gfx/plots/awgn-mcs7}} \\
	\end{tabular}
...
\begin{figure}[p]
	\centering
	\begin{tabular}{cc}
		\subfloat[MCS 0]{\includegraphics[width=0.45\textwidth]{gfx/plots/tgn-mcs0}} &
		\subfloat[MCS 1]{\includegraphics[width=0.45\textwidth]{gfx/plots/tgn-mcs1}} \\
		\subfloat[MCS 2]{\includegraphics[width=0.45\textwidth]{gfx/plots/tgn-mcs2}} &
		\subfloat[MCS 3]{\includegraphics[width=0.45\textwidth]{gfx/plots/tgn-mcs3}} \\
		\subfloat[MCS 4]{\includegraphics[width=0.45\textwidth]{gfx/plots/tgn-mcs4}} &
		\subfloat[MCS 5]{\includegraphics[width=0.45\textwidth]{gfx/plots/tgn-mcs5}} \\
		\subfloat[MCS 6]{\includegraphics[width=0.45\textwidth]{gfx/plots/tgn-mcs6}} &
		\subfloat[MCS 7]{\includegraphics[width=0.45\textwidth]{gfx/plots/tgn-mcs7}} \\
	\end{tabular}
...
\begin{figure}[p]
	\centering
	\begin{tabular}{cc}
		\subfloat[MCS 0]{\includegraphics[width=0.4\textwidth]{gfx/plots/trms-mcs0}} &
		\subfloat[MCS 1]{\includegraphics[width=0.4\textwidth]{gfx/plots/trms-mcs1}} \\
		\subfloat[MCS 2]{\includegraphics[width=0.4\textwidth]{gfx/plots/trms-mcs2}} &
		\subfloat[MCS 3]{\includegraphics[width=0.4\textwidth]{gfx/plots/trms-mcs3}} \\
		\subfloat[MCS 4]{\includegraphics[width=0.4\textwidth]{gfx/plots/trms-mcs4}} &
		\subfloat[MCS 5]{\includegraphics[width=0.4\textwidth]{gfx/plots/trms-mcs5}} \\
		\subfloat[MCS 6]{\includegraphics[width=0.4\textwidth]{gfx/plots/trms-mcs6}} &
		\subfloat[MCS 7]{\includegraphics[width=0.4\textwidth]{gfx/plots/trms-mcs7}} \\
	\end{tabular}
...
Next, I used the same code as for the simulation experiments to try and detect sender \gls{MAC} addresses. Fortunately, this worked well. I ran a total amount of 100 experiments for each \gls{MCS}. The results are shown in figure \ref{fig:warp-mcs-results}.
...
In general, the results were very comparable to those of the simulation, however there was a slightly lower accuracy. The reason for that is probably the channel effects, which could not be simulated in full detail by the channel models.
